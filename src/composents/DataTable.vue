...
const categoryFilteredData = computed(() => {
  ...
  return props.dataSources.filter(
          ...
          <tbody>
            <tr v-for="item in sortedDataSources" :key="item.id">
              ...
              <td class="status-cell">
                ...
                >
                  <span
                    v-if="item.status.toLowerCase() === 'working'"
                    class="icon"
                    >✓</span
                  >

                  <span
                    v-if="item.status.toLowerCase() === 'coming soon'"
                    class="icon"
                    ><img
                      src="https://cdn-icons-png.flaticon.com/512/2089/2089758.png"
                      width="10"
                      height="10"
                      alt="clock"
                      title="clock"
